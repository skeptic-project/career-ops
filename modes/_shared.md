...
9. **Tracker additions as TSV** -- NEVER edit applications.md directly. Write TSV in `batch/tracker-additions/`. Use the 12-column format: `num, date, company, role, status, score, resume-md, final-score, pdf, report, jd, notes`.
