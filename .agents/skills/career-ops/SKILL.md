...
user_invocable: true
user-invocable: true
argument-hint: "[scan | deep | pdf | resume-md | latex | cover | eu-swe | oferta | ofertas | apply | batch | tracker | pipeline | contacto | training | project | interview-prep | interview | patterns | followup | update]"
license: MIT
---
...
Available commands:
  ...
  /career-ops resume-md → Tailor CV and save as markdown file at output/
...
Applies to: `auto-pipeline`, `oferta`, `ofertas`, `pdf`, `resume-md`, `contacto`, `apply`, `pipeline`, `scan`, `batch`
